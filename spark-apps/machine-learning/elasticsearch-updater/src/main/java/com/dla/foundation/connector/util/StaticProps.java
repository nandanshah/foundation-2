...
public enum StaticProps {
	...
	CREATE_INDEX("true"),COUNT_THRESHHOLD("10"),SCHEMA_PATH1("userRecoSchema_1.json"),SCHEMA_PATH2("userrecoSchema_2.json"),SCHEMA_PATH3("Reco_type.json"),INPUT_DATE("input_date");//URL_HOST("http://localhost:9200/"),SPARK_MODE("local")
