...
$SPARK_HOME/bin/spark-submit --master $SPARK_CLUSTER --class com.dla.foundation.trendReco.UserEventSummaryDriver $SH_DIR/../lib/trend-recommendation-0.0.1-SNAPSHOT.jar $SH_DIR/../conf/common.properties --jars $JAR_LIST

echo -e "Submitting Spark Application, trend-recommendation-DayScoreDriver, to Spark Cluster $SPARK_CLUSTER"
$SPARK_HOME/bin/spark-submit --master $SPARK_CLUSTER --class com.dla.foundation.trendReco.DayScoreDriver $SH_DIR/../lib//trend-recommendation-0.0.1-SNAPSHOT.jar $SH_DIR/../conf/common.properties --jars $JAR_LIST
