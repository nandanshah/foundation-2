...
$SPARK_HOME/bin/spark-submit --master $SPARK_CLUSTER --class com.dla.foundation.trendReco.TrendScoreDriver $SH_DIR/../lib/trend-recommendation-0.0.1-SNAPSHOT.jar $SH_DIR/../conf/common.properties --jars $JAR_LIST
