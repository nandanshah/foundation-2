...
$SPARK_HOME/bin/spark-submit --master $SPARK_CLUSTER --class com.dla.foundation.popularity.PopularityClient  $SH_DIR/../lib/popularity-reco-1.0.0.jar $SH_DIR/../conf/common.properties --jars $JAR_LIST
