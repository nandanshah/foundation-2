...
$SPARK_HOME/bin/spark-submit --class com.dla.foundation.useritemreco.UserItemRecoDriver --master $SPARK_CLUSTER $SH_DIR/../lib/user-item-recommendation-1.0.0.jar $SH_DIR/../conf/common.properties --deploy-mode client --jars $JAR_LIST
