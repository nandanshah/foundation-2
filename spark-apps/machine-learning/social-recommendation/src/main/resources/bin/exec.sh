...
echo -e "Submitting Spark Application, social-recommendation, to Spark Cluster $SPARK_CLUSTER"
$SPARK_HOME/bin/spark-submit --master $SPARK_CLUSTER --class com.dla.foundation.socialReco.SocialScoreDriver $SH_DIR/../lib/social-recommendation-1.0.0.jar $SH_DIR/../conf/common.properties --jars $JAR_LIST --executor-memory $EXECUTOR_MEMORY
