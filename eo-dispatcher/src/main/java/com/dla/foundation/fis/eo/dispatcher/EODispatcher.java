...
public interface EODispatcher extends Closeable {
	...
	public boolean profileAdded(UUID tenantId, UUID sessionId, UUID accountId,
			...
			DeviceType deviceType, UUID deviceId, NetworkType networkType)
